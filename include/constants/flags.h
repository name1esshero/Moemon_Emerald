...
#define FLAG_MALE            0x26 //gender set to male
...
#define FLAG_HIDE_FOLLOWER    0x4E // Hides followers
#define FLAG_FORCE_LOAD_OFFSCREEN_OBJEV    0x4F // Forces object events to load offscreen
